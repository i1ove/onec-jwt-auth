...
Функция АвторизоватьсяНаСервере()
	
	PAT = "PAT pat.05b1872e-872c-4821-9fdb-51ef04ff9e2a.4b02527a2ec1d5a6c8ed270380f0f570a42651fc4b8e70a283bbf47af6f530e2";
	//PAT = "PAT pat.2c24a1cf-935f-49ac-8417-236a5524d4d5.82f9dfc6f4710e17bf5de5f077b0f9c5ec0e7a3e3b16358d1cb49b783548b289";
...
Процедура СгенерироватьPAT(Команда)
	СгенерироватьPATНаСервере();
КонецПроцедуры

&НаСервере
Процедура СгенерироватьPATНаСервере()
	...
	// Показать PAT пользователю один раз
	Сообщить("PAT: " + Рез.PAT);
КонецПроцедуры
...
Процедура Контакты(Команда)
	Сообщить(КонтактыНаСервере(ТокенJWT));
КонецПроцедуры
